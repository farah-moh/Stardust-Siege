...
namespace our {
    ...
    public:
        ...
        T* addComponent(){
            ...
            //TODO: (Req 8) Create a component of type T, set its "owner" to be this entity, then push it into the component's list
        ...
        void deleteComponent(T const* component){
            ...
            for (auto it = components.begin(); it != components.end(); it++)
            {
                Component* myComponent = *it;
                T* componentFound = dynamic_cast<T*>(myComponent);
                if(componentFound && componentFound == component){
                    delete myComponent;
                    components.erase(it);
                }
            }
